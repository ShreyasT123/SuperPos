...
// Reusable Video Player Component (Improved Responsive Styling)
const VideoPlayer = ({
  src,
  poster,
  controls = true,
      ...
      <div className="space-y-8">
        ...
        <section className="bg-gray-900 rounded-lg p-6 shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-white text-center">
            Lesson Video: Entering the Quantum Realm
          </h2>
          <VideoPlayer
            src="/placeholder-video-intro.mp4" // *** Replace with actual video path ***
            poster="/placeholder-poster-intro.jpg" // *** Replace with actual poster image path ***
            controls={true}
            // Width/Height will be handled by component's responsive styling
          />
          {/* Summary (Keep relevant points for an intro) */}
          <div className="mt-6">
            ...
            <ul className="list-disc list-inside text-gray-300 mt-2 space-y-1 max-w-md mx-auto">
              <li>What makes quantum computing different?</li>
              <li>Brief introduction to qubits and superposition.</li>
              <li>The idea of quantum parallelism.</li>
              <li>Potential real-world applications and impact.</li>
              <li>Classical vs. Quantum basic differences.</li>
            </ul>
          </div>
        </section>
